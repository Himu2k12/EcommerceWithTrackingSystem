        ...
        <div class="col-sm-offset-3 col-sm-8">
            <div class="well">
                ...
                <form action="{{ url('/new-product') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3">Product Image2</label>
                        <div class="col-sm-9">
                            <input type="file" name="product_image2" accept="image/*">
                            <span style="color: red;">{{ $errors->has('product_image2') ? $errors->first('product_image2') : ' ' }}</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3">Product Image3</label>
                        <div class="col-sm-9">
                            <input type="file" name="product_image3" accept="image/*">
                            <span style="color: red;">{{ $errors->has('product_image3') ? $errors->first('product_image3') : ' ' }}</span>
                        </div>
                    </div>
                    <div class="form-group">
